function About(){
  return (
    <div className="about">
      ...
      <p className="legal">
        Consumer experience is our utmost proprity. We strongly value our relationships with our consumers and believe that a hassle-free experience equals a happy consumer.
      </p>
    </div>
  )
}
